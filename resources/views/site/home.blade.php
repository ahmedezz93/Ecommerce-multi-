            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        <h3 class="heading">{{ $parent_category->name }}</h3>
                        <ul>
                            @if ($parent_category->childs)

                            @foreach ($parent_category->childs as $child_category )
                            <li><a href="product-grids.html">{{ $child_category->name }}</a></li>
                            @endforeach
                            @endif
                        </ul>
                        @if ($parent_category->image_url)
                        <div class="images">
                            <img src="{{ $parent_category->image_url }}" >
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            ...
                            <span class="sale-tag">-{{($product->percentage_discount)}}%</span>
                            @else
                            <span class="new-tag">New</span>
                            @endif

                            <div>
                                <a href="{{ route('add.to.cart',$product->id) }}" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
