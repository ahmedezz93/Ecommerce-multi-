                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            @if ($product->price)
                                <h3 class="price">{{ Currency::format($product->price, 'SAR') }}
                                    <span>{{ Currency::format($product->compare_price, 'SAR') }}</span>
                                </h3>
                            @else
                                <h3 class="price">{{ Currency::format($product->compare_price, 'SAR') }} </span></h3>
                            @endif
                                        ...
                                        <div class="form-group quantity">
                                            ...
                                            <select class="form-control" name="quantity">
                                                ...
                                                for ($i = 1; $i <= $product->quantity; $i++) {
                                                    $selected = '';
                                                    if ($product->cart && $product->cart->quantity == $i) {
                                                        $selected = 'selected';
                                                    }
